    ...
    public void getPeristiwaBarisPerBaris(LocalDate tanggal, JTextArea txtAreaPeristiwa, Supplier<Boolean> shouldStop) {
        try {
            ...
            try (BufferedReader in = new BufferedReader(new InputStreamReader(conn.getInputStream()))) {
                ...
                // Menggabungkan semua data dari input stream
                while ((inputLine = in.readLine()) != null) {
                ...
                // Menampilkan data peristiwa ke dalam JTextArea
                for (int i = 0; i < events.length(); i++) {
                    ...
                    // Terjemahkan deskripsi peristiwa
                    String translatedDescription = translateToIndonesian(description);

                    // Gabungkan tahun dan deskripsi yang diterjemahkan
                    String peristiwa = year + ": " + translatedDescription;

                    // Menambahkan peristiwa ke dalam JTextArea di EDT
